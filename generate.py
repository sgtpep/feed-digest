...
if __name__ == '__main__':
    ...
    for entry in entries:
        if entry['group_timestamp'] != prev_entry['group_timestamp']:
            ...
            """
            print >> f, u"""<!--#exec cmd="shift; echo \\"<script>var lastFilename = \\\\"{}\\\\";</script>\\" > /var/tmp/feed-digest-last-filename.html" -->""".format(group_filename)
    ...
    print >> f, u"""
    <!--#exec cmd="shift; cat /var/tmp/feed-digest-last-filename.html" --> 
